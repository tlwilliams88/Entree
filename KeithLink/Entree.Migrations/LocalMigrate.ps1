...
if ($rollback -gt 0) {
	...
	& ..\..\..\packages\FluentMigrator.Tools.1.6.2\tools\AnyCPU\40\Migrate.exe /verbose "1" /conn "Data Source=localhost;Initial Catalog= BEK_Commerce_AppData;Integrated Security=SSPI;" /assembly "Entree.Migrations.dll" /provider sqlserver2012 /profile "Debug" /task rollback
} else {
