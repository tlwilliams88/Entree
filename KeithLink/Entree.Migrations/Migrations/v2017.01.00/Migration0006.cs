...
namespace Entree.Migrations {
    ...
    public class Migration6 : Migration {
        public override void Up() {
            ...
            foreach (string script in ScriptsCollectionHelper.GetAllMigrationFiles("0006", "up")) {
        ...
        public override void Down() {
            ...
            foreach (string script in ScriptsCollectionHelper.GetAllMigrationFiles("0006", "down")) {
                this.Execute.Script(script);
            }
        }
    }
