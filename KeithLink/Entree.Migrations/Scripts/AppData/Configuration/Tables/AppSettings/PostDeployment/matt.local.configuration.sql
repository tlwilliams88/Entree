...
-- Confirmations
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQConfirmationQueue', 'matt_confirmations', 'RabbitMQ Settings: Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQConfirmationErrorQueue', 'matt_confirmations_error', 'RabbitMQ Settings: Queue', 0)

-- Notifications
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQETAQueue', 'matt_notifications_eta', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQHasNewsQueue', 'matt_notifications_hasnews', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQNotificationErrorQueue', 'matt_notifications_errors', 'RabbitMQ Notifications Error Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQNotificationQueueExternal', 'matt_notifications_external', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQNotificationQueue', 'matt_notifications', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderConfirmationQueue', 'matt_notifications_orderconfirmations', 'RabbitMQ Settings: Notification Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQPaymentConfirmationQueue', 'matt_notifications_paymentconfirmations', 'RabbitMQ Settings: Queue', 0)

-- Push Notifications
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQPushMessagesQueue', 'matt_notifications_push_messages', 'RabbitMQ Settings: Queue', 0)

-- Requests
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderErrorQueue', 'matt_orders_error', 'RabbitMQ Settings: Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQUpdateRequestQueue', 'matt_orders_historyrequest', 'RabbitMQ Settings: Queue', 0)

-- Order Processing
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderQueue', 'matt_orders_created', 'RabbitMQ Settings: Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderReprocessQueue', 'matt_orders_reprocess', 'RabbitMQ Settings: Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderHistoryQueue', 'matt_orders_history', 'RabbitMQ Settings: Queue', 0)

-- Order Updates
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderUpdateQueue', 'matt_orders_updates', 'RabbitMQ Settings: Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQSpecialOrderUpdateQueue', 'matt_specialorders_updates', 'RabbitMQ Settings: Queue', 0)
