...
/* AD Settings */
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('ADBadPwdCount', '5', 'Active Directory Settings', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('ElasticSearchURL', 'http://localhost:9200', 'Elastic Search Settings', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('FailureEmailAddress', 'jwames@benekeith.com', 'Email Settings', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQConfirmationQueue', 'confirmations_dev_jeremy', 'RabbitMQ Settings: Queue', 0)
...
-- Notifications
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQETAQueue', 'notifications_v2_dev_eta', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQHasNewsQueue', 'notifications_v2_dev_hasnews', 'RabbitMQ Settings: Notifications Queue', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQNotificationQueueExternal', 'notifications_dev_external', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQNotificationQueue', 'notifications_jeremy', 'RabbitMQ Settings: Notifications Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderConfirmationQueue', 'notifications_v2_dev_orderconfirmations', 'RabbitMQ Settings: Notification Queue', 0)
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQPaymentConfirmationQueue', 'notifications_v2_dev_paymentconfirmations', 'RabbitMQ Settings: Queue', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQPushMessagesQueue', 'notifications_push_messages_dev', 'RabbitMQ Settings: Queue', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderQueue', 'orders_created_dev_jeremy', 'RabbitMQ Settings: Queue', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('RabbitMQOrderUpdateQueue', 'orders_updates_dev_jeremy', 'RabbitMQ Settings: Queue', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('UNFIWhitelistBEKUsers', 'jwames', 'UNFI Whitelisting', 0)
