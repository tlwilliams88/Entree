...
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'RabbitMQ Settings: Servers', 'RabbitMQAccessServer', 'prodrmq.benekeith.com', 0)
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'RabbitMQ Settings: Servers', 'RabbitMQConfirmationServer', 'prodrmq.benekeith.com', 0)
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'RabbitMQ Settings: Servers', 'RabbitMQNotificationServer', 'prodrmq.benekeith.com', 0)
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'RabbitMQ Settings: Servers', 'RabbitMQOrderServer', 'prodrmq.benekeith.com', 0)
...
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'MultiDocs Settings', 'MultiDocsProxyUrl', 'https://shop.benekeith.com/multidocsurl/', 0)    
...
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'Misc Settings', 'CacheServerEndpoints', 'http://bekkecpas1:5006,http://bekkecpas2:5006', 0)
INSERT INTO @AppSettings (Comment, [Key], Value, [Disabled]) VALUES( 'Misc Settings', 'EntreeSiteURL', 'https://shop.benekeith.com', 0)
...
INSERT @AppSettings ([Key], [Value], [Comment], [Disabled]) VALUES ('QueuesToCheck', '{targets:[
 {"server":"qarmq.benekeith.com",
  ...
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"100"},
 {"server":"qarmq.benekeith.com",
  "username":"notifyclnt",
  "password":"notifypassclnt",
  "virtualhost":"notifications_notify",
  "logicalname":"notifications_paymentconfirmations",
  "queue":"notifications_paymentconfirmations",
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"100"},
 {"server":"qarmq.benekeith.com",
  "username":"notifyclnt",
  ...
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"1000"},
 {"server":"qarmq.benekeith.com",
  "username":"notifyclnt",
  "password":"notifypassclnt",
  "virtualhost":"notifications_notify",
 ...
 {"server":"qarmq.benekeith.com",
  ...
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"200"},
 {"server":"qarmq.benekeith.com",
  "username":"orderclnt",
  "password":"ordpassclnt",
  "virtualhost":"orders_createupdate",
  "logicalname":"orders_created",
 ...
 {"server":"qarmq.benekeith.com",
  ...
  "password":"ordpassclnt",
  "virtualhost":"orders_createupdate",
  "logicalname":"orders_history",
  "queue":"orders_history",
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"100"},
 {"server":"qarmq.benekeith.com",
  "username":"orderclnt",
  ...
  "logicalname":"confirmations",
  "queue":"confirmations_qa",
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"100"},
 {"server":"qarmq.benekeith.com",
  "username":"orderclnt",
  "password":"ordpassclnt",
  "virtualhost":"orders_statusnotification",
  "logicalname":"orders_updates",
  "queue":"orders_updates",
  "minimumconsumerswarningthreshold":"0",
  "maximummessageswarningthreshold":"100"}
 ]
