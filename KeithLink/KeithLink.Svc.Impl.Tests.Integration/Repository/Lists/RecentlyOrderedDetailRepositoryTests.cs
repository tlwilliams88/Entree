...
namespace KeithLink.Svc.Impl.Tests.Integration.Repository.Lists {
    public class RecentlyOrderedListDetailsRepositoryTests {
        private static IRecentlyOrderedListDetailsRepository MakeRepo() {
            IContainer diMap = DependencyMapFactory.GetTestsContainer()
                                                   .Build();
            return diMap.Resolve<IRecentlyOrderedListDetailsRepository>();
        }

        public class DeleteRecentlyOrderedListDetail : MigratedDatabaseTest {
            [Fact]
            public void GoodDetailId_RemovesExpectedRecord() {
                ...
                // act
                repo.DeleteRecentlyOrdered(detailId);
                var results = repo.GetRecentlyOrderedDetails(headerId);
            ...
            public void GoodDaysToKeep_RemovesExpectedRecords() {
                ...
                // act
                repo.DeleteOldRecentlyOrdered(headerId, daysToKeep);
                var results = repo.GetRecentlyOrderedDetails(headerId);
        ...
        public class GetRecentlyOrderedsDetails : MigratedDatabaseTest {
            [Fact]
        ...
        public class SaveRecentlyOrderedListDetail : MigratedDatabaseTest { 
