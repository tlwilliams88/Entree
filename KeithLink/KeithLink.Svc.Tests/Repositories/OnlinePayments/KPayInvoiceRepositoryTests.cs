...
namespace KeithLink.Svc.Test.Repositories.OnlinePayments {
    ...
    public class KPayInvoiceRepositoryTests {
		...
		//All of these test are very dependant on specific data being in a real database. A mock db context should be created with test data so that 
		//these will pass every run. Until then, they have been commented out.
        #region methods
		//[TestMethod]
