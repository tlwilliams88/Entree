...
namespace KeithLink.Svc.Impl.Repository.Profile
{
    public class AccountRepository : BaseOrgRepository, Core.Interface.Profile.IAccountRepository
    {
		...
		{
            Entree.Core.Models.Generated.SiteTerm orgTypes = GetOrganizationTypes();
            string accountOrgTypeId = orgTypes.Elements.Where(o => o.DisplayName == "Account").FirstOrDefault().Id;

            var createOrg = new CommerceServer.Foundation.CommerceCreate<Entree.Core.Models.Generated.Organization>("Organization");
		...
		{
			var deleteOrg = new CommerceServer.Foundation.CommerceDelete<Entree.Core.Models.Generated.Organization>("Organization");
        ...
        public Guid UpdateAccount(string name, Guid accountId) {
            ...
            var createOrg = new CommerceServer.Foundation.CommerceUpdate<Entree.Core.Models.Generated.Organization>();
        ...
        {
            var queryOrg = new CommerceServer.Foundation.CommerceQuery<Entree.Core.Models.Generated.Organization>("Organization");
            ...
            System.Threading.Tasks.Parallel.ForEach(res.CommerceEntities, e =>
                {
                    Entree.Core.Models.Generated.Organization org = new Entree.Core.Models.Generated.Organization(e);
        ...
        {
            var updateQuery = new CommerceUpdate<Entree.Core.Models.Generated.Organization>("Organization");
