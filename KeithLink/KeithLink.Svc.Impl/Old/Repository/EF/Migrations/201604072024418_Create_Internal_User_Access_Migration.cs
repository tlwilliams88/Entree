namespace KeithLink.Svc.Impl.Migrations
{
    ...
    public partial class Create_Internal_User_Access_Migration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .Index(t => t.EmailAddress, name: "IdxByEmailAddress");
            
        }
        
        public override void Down()
        {
            DropIndex("Customers.InternalUserAccess", "IdxByEmailAddress");
