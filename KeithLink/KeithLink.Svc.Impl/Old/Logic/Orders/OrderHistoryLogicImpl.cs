...
using Entree.Core.Extensions.Enumerations;
using Entree.Core.Extensions.Orders;
using Entree.Core.Extensions.Orders.Confirmations;
...
namespace KeithLink.Svc.Impl.Logic.Orders {
    public class OrderHistoryLogicImpl : IOrderHistoryLogic {
            ...
            (bool isSpecialOrder, EF.OrderHistoryHeader header, OrderHistoryDetail currentDetail, EF.OrderHistoryDetail detail)
        {
            ...
            if (isSpecialOrder)
            {
                detail.ItemStatus = Entree.Core.Constants.SPECIALORDERITEM_REQ_STATUS_TRANSLATED_CODE;
            }
        ...
        private void AddNewDetailToOrder(bool isSpecialOrder, EF.OrderHistoryHeader header, OrderHistoryDetail currentDetail)
        {
            ...
            if (isSpecialOrder)
            {
                tempDetail.ItemStatus = Entree.Core.Constants.SPECIALORDERITEM_REQ_STATUS_TRANSLATED_CODE;
            }
