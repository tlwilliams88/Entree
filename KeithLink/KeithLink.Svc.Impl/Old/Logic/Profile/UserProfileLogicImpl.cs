...
using Entree.Core.Extensions.SingleSignOn;
...
using Entree.Core.Models.SingleSignOn;
...
namespace KeithLink.Svc.Impl.Logic.Profile {
    public class UserProfileLogicImpl : IUserProfileLogic {
        ...
        public bool CheckCanViewUNFI(UserProfile user, string customernumber, string customerbranch)
        {
            if ((user != null) &&
                (user.IsInternalUser) &&
