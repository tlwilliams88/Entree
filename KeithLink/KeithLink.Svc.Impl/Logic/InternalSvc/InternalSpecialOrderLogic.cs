...
{
    public class InternalSpecialOrderLogic : IInternalSpecialOrderLogic
    {
        #region attributes
        ...
        #region ctor
        public InternalSpecialOrderLogic(IUnitOfWork unitOfWork, IEventLogRepository log, IGenericQueueRepository queue, IOrderHistoryDetailRepository detailRepo,
            IOrderHistoryHeaderRepsitory headerRepo)
        {
        ...
        {
            EF.OrderHistoryHeader header = detail.OrderHistoryHeader;
            header.DeliveryDate = specialorder.Item.EstimatedArrival.Value;
