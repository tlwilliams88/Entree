...
{
    public class ContractChangesRopositoryImpl : DapperDatabaseConnection, IContractChangesRepository
    {
        #region attributes
        ...
        #region constructor
        public ContractChangesRopositoryImpl() : base(Configuration.BEKDBConnectionString)
        {
        ...
        public void Update(long ParentListId, bool Sent)
        {
            DynamicParameters parms = new DynamicParameters();
            parms.Add("@Sent", Sent);
            parms.Add("@Id", ParentListId);
