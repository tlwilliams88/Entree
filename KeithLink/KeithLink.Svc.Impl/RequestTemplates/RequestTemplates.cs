...
/// <returns>A CommerceEntity from the response when there is one, null otherwise.</returns>
public static List<CommerceEntity> AddToCart(string name, string userId, string basketType, string refreshBasket, string catalogName, string productId, string variantId, string quantity)
{
...
/// <returns>Commerce Server Contrib controller which can be used to get the response.</returns>
public static BaseController<IRequestTemplateController> AddToCartQueued(string name, string userId, string basketType, string refreshBasket, string catalogName, string productId, string variantId, string quantity)
{
