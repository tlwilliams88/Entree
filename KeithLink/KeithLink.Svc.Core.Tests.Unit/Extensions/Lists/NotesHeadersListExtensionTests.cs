...
namespace KeithLink.Svc.Core.Tests.Unit.Extensions.Lists {
    public class NotesHeadersListExtensionTests {
        private static NotesListHeader MakeHeader() {
        ...
        private static List<NotesListDetail> MakeListOfDetails() {
            return new List<NotesListDetail>() {
                new NotesListDetail() {
                    Id = 1,
                    CatalogId = "FUT",
                    Each = false,
