...
namespace KeithLink.Svc.Core.Tests.Unit.Extensions.Lists {
    public class RecommendedDetailExtensionTests {
        ...
        public class ToWebModel {
            ...
            public void GoodDetail_ReturnsExpectedType() {
                // arrange
                RecommendedItemsListDetail detail = MakeDetail();
                ListType expected = ListType.RecommendedItems;
        ...
        public class ToRecommendedItemsListDetail {
            ...
            public void GoodModel_ReturnsExpectedCatalogId() {
                ...
                // act
                RecommendedItemsListDetail results = model.ToRecommendedItemsListDetail();
            ...
            public void GoodModelWithHeaderId_ReturnsExpectedHeaderId() {
                ...
                // act
                RecommendedItemsListDetail results = model.ToRecommendedItemsListDetail(headerId);
