...
namespace KeithLink.Svc.Impl.Tests.Unit.Service.List
{
    public class ListServiceTests : BaseDITests
    {
        ...
        {
            [Fact]
            public void AnyUserAnyContextWithTypeFavorites_CallsFavoritesListLogicSaveList()
            {
                // arrange
                MockDependents mockDependents = new MockDependents();
                IListService testunit = MakeTestsService(false, ref mockDependents);
                ...
                // act
                testunit.AddItem(fakeUser, testcontext, testListType, testHeaderId, testListItem);

                // assert
                mockDependents.FavoritesListLogic.Verify(m => m.SaveList(It.IsAny<UserProfile>(), It.IsAny<UserSelectedContext>(), It.IsAny<ListModel>()), Times.Once, "not called");
            }
            ...
            public void AnyUserAnyContextWithTypeReminder_CallsRemindersListLogicSaveList()
            {
                ...
                // assert
                mockDependents.RemindersListLogic.Verify(m => m.SaveList(It.IsAny<UserProfile>(), It.IsAny<UserSelectedContext>(), It.IsAny<ListModel>()), Times.Once, "not called");
            }
            ...
            public void AnyUserAnyContextWithTypeMandatory_CallsMandatoryItemsListLogicSaveList()
            {
                ...
                // assert
                mockDependents.MandatoryItemsListLogic.Verify(m => m.SaveList(It.IsAny<UserProfile>(), It.IsAny<UserSelectedContext>(), It.IsAny<ListModel>()), Times.Once, "not called");
            }
            ...
            public void AnyUserAnyContextWithTypeInventoryValuation_CallsInventoryValuationListLogicSaveList()
            {
                ...
                // assert
                mockDependents.InventoryValuationListLogic.Verify(m => m.SaveList(It.IsAny<UserProfile>(), It.IsAny<UserSelectedContext>(), It.IsAny<ListModel>()), Times.Once, "not called");
            }
