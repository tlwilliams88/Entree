        ...
        public class MockDependents {
            ...
            public static void RegisterInContainer(ref ContainerBuilder cb) {
                cb.RegisterInstance(MakeMockCatalogLogic()
                                            .Object)
                  .As<ICatalogLogic>();
                cb.RegisterInstance(MakeMockCustomerRepository()
                                            .Object)
                  .As<ICustomerRepository>();
                cb.RegisterInstance(MakeMockEventLogRepository()
                                            .Object)
                  .As<IEventLogRepository>();
                cb.RegisterInstance(MakeMockGenericQueueRepository()
                                            .Object)
                  .As<IGenericQueueRepository>();
                cb.RegisterInstance(MakeMockContractChangesRepository()
                                            .Object)
                  .As<IContractChangesRepository>();
                cb.RegisterInstance(MakeMockMessageTemplateLogic()
                                            .Object)
            ...
            public static Mock<IContractChangesRepository> MakeMockContractChangesRepository() {
                Mock<IContractChangesRepository> mock = new Mock<IContractChangesRepository>();

                return mock;
            }

            public static Mock<IMessageTemplateLogic> MakeMockMessageTemplateLogic() {
                Mock<IMessageTemplateLogic> mock = new Mock<IMessageTemplateLogic>();
