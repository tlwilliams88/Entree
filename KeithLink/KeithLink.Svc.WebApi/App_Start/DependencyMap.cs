...
namespace KeithLink.Svc.WebApi
{
    internal static class DependencyMap
    {
        public static AutofacWebApiDependencyResolver Build()
        {
            ...
            builder.RegisterType<Repository.OnlinePayments.Customer.CustomerBankServiceRepositoryImpl>().As<ICustomerBankServiceRepository>();
            ...
            builder.RegisterType<KeithLink.Svc.WebApi.com.benekeith.CustomerBankService.CustomerBankServiceClient>().As<KeithLink.Svc.WebApi.com.benekeith.CustomerBankService.ICustomerBankService>();
