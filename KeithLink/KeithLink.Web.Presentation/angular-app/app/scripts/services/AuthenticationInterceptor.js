...
.factory('AuthenticationInterceptor', ['$q', '$location', 'localStorageService', 'Constants', 'ApiSettings', 'ENV',
  function ($q, $location, localStorageService, Constants, ApiSettings, ENV) {
